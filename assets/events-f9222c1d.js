...
Object.defineProperty(o, "defaultMaxListeners", {
    ...
    set: function(t) {
        if (typeof t != "number" || t < 0 || L(t)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + t + ".");
        m = t
    }
});
o.init = function() {
...
o.prototype.emit = function(e) {
    ...
    if (typeof c == "function") d(c, this, n);
        ...
        for (var h = c.length, O = E(c, h), r = 0; r < h; ++r) d(O[r], this, n);
    return !0
};
