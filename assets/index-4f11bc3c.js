...
const fe = Symbol(),
    ...
    F = new WeakMap,
    me = e => e && (F.has(e) ? F.get(e) : Z(e) === Object.prototype || Z(e) === Array.prototype),
    ge = e => me(e) && e[fe] || null,
    ee = (e, t = !0) => {
        F.set(e, t)
    },
    ...
    C = new WeakMap,
    x = new WeakSet,
    he = (e = Object.is, t = (o, h) => new Proxy(o, h), s = o => J(o) && !x.has(o) && (Array.isArray(o) || !(Symbol.iterator in o)) && !(o instanceof WeakMap) && !(o instanceof WeakSet) && !(o instanceof Error) && !(o instanceof Number) && !(o instanceof Date) && !(o instanceof String) && !(o instanceof RegExp) && !(o instanceof ArrayBuffer), r = o => {
        switch (o.status) {
            case "fulfilled":
                return o.value;
            case "rejected":
        ...
        return ee(y, !0), l.set(o, [h, y]), Reflect.ownKeys(o).forEach(P => {
            ...
            if (x.has(L)) ee(L, !1);
            else if (L instanceof Promise) delete D.value, D.get = () => I(L);
            else if (C.has(L)) {
                const [v, z] = C.get(L);
                D.value = c(v, z(), I)
            }
            ...
            V = t(H, {
                ...
                set(i, a, n, g) {
                    const R = Reflect.has(i, a),
                        N = Reflect.get(i, a, g);
                    if (R && (e(N, n) || m.has(n) && e(N, m.get(n)))) return !0;
                    Y(a), J(n) && (n = ge(n) || n);
                    let $ = n;
                    ...
                    return Reflect.set(i, a, $, g), y(["set", [a], n, N]), !0
                }
            });
        m.set(o, V);
        const ue = [H, L, c, de];
        return C.set(V, ue), Reflect.ownKeys(o).forEach(i => {
...
const d = S({
    ...
    p = {
        ...
        setWalletConnectDeepLink(e, t) {
            try {
                localStorage.setItem(p.WALLETCONNECT_DEEPLINK_CHOICE, JSON.stringify({
                    href: e,
                    name: t
                }))
            } catch {
    ...
    ve = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")),
    u = S({
        enabled: ve,
        userSessionId: "",
        events: [],
...
var Ie = Object.defineProperty,
    ...
    Le = (e, t) => {
        for (var s in t || (t = {})) Ee.call(t, s) && se(e, s, t[s]);
        if (te)
            for (var s of te(t)) Oe.call(t, s) && se(e, s, t[s]);
        return e
    };
...
async function K(e, t) {
    const s = Le({
        ...
        r = new URL(e, G);
    return r.searchParams.append("projectId", k.state.projectId), Object.entries(s).forEach(([l, c]) => {
...
const j = {
    ...
    getWalletImageUrl(e) {
        return `${G}/w3m/v1/getWalletImage/${e}?projectId=${k.state.projectId}&sdkType=${Q}&sdkVersion=${X}`
    },
    getAssetImageUrl(e) {
        return `${G}/w3m/v1/getAssetImage/${e}?projectId=${k.state.projectId}&sdkType=${Q}&sdkVersion=${X}`
    }
};
var We = Object.defineProperty,
    ...
    Se = (e, t) => {
        ...
        if (oe)
            for (var s of oe(t)) Ce.call(t, s) && ne(e, s, t[s]);
        return e
    };
const re = p.isMobile(),
    O = S({
    ...
    Ne = {
        ...
        async getRecomendedWallets() {
            ...
            if (p.isArray(e)) {
                ...
                const {
                    chains: s,
                    isAuth: r
                } = w.state, l = s == null ? void 0 : s.join(","), c = p.isArray(t), m = {
                    page: 1,
                    ...
                    listings: f
                } = re ? await j.getMobileListings(m) : await j.getDesktopListings(m);
        ...
        async getWallets(e) {
            ...
            const {
                ...
                listings: f,
                total: W
            } = re ? await j.getMobileListings(t) : await j.getDesktopListings(t), o = Object.values(f), h = m ? "search" : "wallets";
            return O[h] = {
                listings: [...O[h].listings, ...o],
                total: W,
                page: c ? ? 1
            }, {
                listings: o,
    ...
    q = {
        ...
        async open(e) {
            return new Promise(t => {
                ...
                if (p.removeWalletConnectDeepLink(), w.setWalletConnectUri(e == null ? void 0 : e.uri), w.setChains(e == null ? void 0 : e.chains), ce.reset("ConnectWallet"), s && r) _.open = !0, t();
                else {
                    const l = setInterval(() => {
                        const c = w.state;
...
var De = Object.defineProperty,
    ...
    Ue = (e, t) => {
        ...
        if (ae)
            for (var s of ae(t)) Me.call(t, s) && ie(e, s, t[s]);
        return e
    };
...
const T = S({
    ...
    le = {
        ...
        setThemeConfig(e) {
            ...
            t && (T.themeMode = t), s && (T.themeVariables = Ue({}, s))
        }
    },
    M = S({
        open: !1,
...
class Re {
    constructor(t) {
        this.openModal = q.open, this.closeModal = q.close, this.subscribeModal = q.subscribe, this.setTheme = le.setThemeConfig, le.setThemeConfig(t), k.setConfig(t), this.initUi()
    }
    async initUi() {
        if (typeof window < "u") {
            await pe(() =>
                import ("./index-57d7e216.js"), ["assets/index-57d7e216.js", "assets/index-567080d8.js", "assets/index-00ea8131.css"]);
...
const Ve = Object.freeze(Object.defineProperty({
    __proto__: null,
    WalletConnectModal: Re
}, Symbol.toStringTag, {
    value: "Module"
}));
export {
    we as R, ce as T, p as a, Ve as i, le as n, Te as o, w as p, q as s, Ne as t, k as y
};